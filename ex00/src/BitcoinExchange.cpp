...
std::map<std::string, double> const &Converter::getQuotes() const {return (_quotes);}

void Converter::_readDatabase()
{
...
void Converter::execute(char const *fileName)
{
...
bool Converter::_validateDate(std::string const &date)
{
...
double Converter::_validatePrice(std::string const &valueStr)
{
	double priceValue;
...
void Converter::_multiplyWithQuote(std::string const &date, double price)
{
